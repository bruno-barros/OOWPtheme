...
class Facebook_Like_Widget extends WP_Widget {
	...
	function Facebook_Like_Widget()
	{
		...
		$this->WP_Widget('facebook-like-widget', 'Facebook Like Box', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_faces'); ?>">Exibir foto</label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_stream'); ?>">Exibir publicações</label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_header'); ?>">Exibir cabeçalho do FB</label>
		</p>
	<?php
	}
}
