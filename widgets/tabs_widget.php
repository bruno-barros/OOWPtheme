...
class Pyre_Tabs_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'pyre_tabs', 'description' => 'Posts populares, post recentes e comentários.');

		$control_ops = array('id_base' => 'pyre_tabs-widget');

		$this->WP_Widget('pyre_tabs-widget', 'Abas', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id('posts'); ?>">Número de posts populares:</label>
			<input class="widefat" style="width: 30px;" id="<?php echo $this->get_field_id('posts'); ?>" name="<?php echo $this->get_field_name('posts'); ?>" value="<?php echo $instance['posts']; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('tags'); ?>">Número de posts recentes:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('comments'); ?>">Número de comentários:</label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_popular_posts'); ?>">Exibir posts populares</label>
		</p>
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_recent_posts'); ?>">Exibir posts recentes</label>
		</p>
		<p>
			<input class="checkbox" type="checkbox" <?php checked($instance['show_comments'], 'on'); ?> id="<?php echo $this->get_field_id('show_comments'); ?>" name="<?php echo $this->get_field_name('show_comments'); ?>" /> 
			<label for="<?php echo $this->get_field_id('show_comments'); ?>">Exibir comentários</label>
		</p>
	<?php }
}
?>