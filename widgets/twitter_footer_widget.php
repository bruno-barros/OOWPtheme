<?php
add_action('widgets_init', 'tweets_footer_load_widgets');

function tweets_footer_load_widgets()
{
	register_widget('Tweets_Footer_Widget');
}

class Tweets_Footer_Widget extends WP_Widget {
	
	function Tweets_Footer_Widget()
	{
		$widget_ops = array('classname' => 'tweets_footer', 'description' => '');

		$control_ops = array('id_base' => 'tweets_footer-widget');

		$this->WP_Widget('tweets_footer-widget', 'Twitter (Footer)', $widget_ops, $control_ops);
	}
