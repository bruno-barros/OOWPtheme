...
class Recent_Works_Widget extends WP_Widget {
	...
	function Recent_Works_Widget()
	{
		...
		$this->WP_Widget('recent_works-widget', 'Trabalhos recentes', $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'Trabalhos recentes', 'number' => 6);
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>">Número de itens exibidos:</label>
